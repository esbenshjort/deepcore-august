...
- PASS  Walking injury restricts walking (compounds accident risk path)
- PASS  Injured walk mul < healthy baseline

## Rarity
- PASS  Broken bones uncommon in typical fall picks (< 25%) — bones=27/200
- PASS  Critical injuries rare (< 8%) — crit=0/200

## Rates (seeded exposure runs)
- AuditStumbleCount=10
- AuditFallCount=5
- AuditInjuryCount=8
- AuditBrokenBoneCount=5
