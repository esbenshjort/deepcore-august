...
PASS | B. Sustained proximity: pressure accumulates or encounter fires — P=0.66 encΔ=4
PASS | C. Brief crossing usually no encounter — encΔ=0 P=0.07
PASS | D. Sustained proximity can produce encounter — encΔ=2 P=0.13
...
- Pair encounter counts:
  ...
  - 2/5: 1
  - 3/4: 1
- Last: IGNORED_AGGRESSION | LIVE falloff=0.48 intens=0.43 ctx=IdleNearby×0.85 relMul=1 focusDamp=0.85 Δh=0.1 P=1.06/1.05
