...
|---|---:|:---:|
| ReturnStrength | 461 | no |
| Attenuation | 671 | no |
| Conductivity | 611 | no |
| StructuralCoherence | 601 | no |
| BoundarySharpness01 | 471 | no |
| ReturnStrength+Attenuation | 701 | no |
| ReturnStrength+Conductivity | 771 | no |
| ReturnStrength+StructuralCoherence | 631 | no |
| ReturnStrength+BoundarySharpness01 | 541 | no |
| Attenuation+Conductivity | 891 | no |
| Attenuation+StructuralCoherence | 721 | no |
| Attenuation+BoundarySharpness01 | 621 | no |
| Conductivity+StructuralCoherence | 831 | no |
| Conductivity+BoundarySharpness01 | 701 | no |
| StructuralCoherence+BoundarySharpness01 | 591 | no |
| BoundaryCharacter (class) | 561 | no |
