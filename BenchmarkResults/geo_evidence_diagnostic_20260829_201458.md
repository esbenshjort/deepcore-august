...
| Bedrock/Fractured | 40 | 37.5 | 0.0 | 2.5 | 25.0 | 20.0 | 15.0 | 0.0 | 0.0 | 3.18 | 3.65 |
| Mineral/Nominal | 40 | 35.0 | 12.5 | 25.0 | 12.5 | 2.5 | 12.5 | 0.0 | 0.0 | 3.55 | 3.10 |
| Mineral/Dense | 40 | 57.5 | 7.5 | 22.5 | 7.5 | 2.5 | 2.5 | 0.0 | 0.0 | 3.33 | 3.03 |
| Mineral/Vein | 40 | 7.5 | 20.0 | 30.0 | 30.0 | 5.0 | 7.5 | 0.0 | 0.0 | 3.48 | 3.55 |
| Gas/Nominal | 40 | 0.0 | 5.0 | 2.5 | 22.5 | 62.5 | 7.5 | 0.0 | 0.0 | 2.58 | 4.53 |
| Gas/TrappedPocket | 40 | 0.0 | 5.0 | 0.0 | 27.5 | 62.5 | 5.0 | 0.0 | 0.0 | 2.43 | 4.68 |
| Mixed/Bedrock+Gas | 40 | 0.0 | 10.0 | 0.0 | 30.0 | 57.5 | 2.5 | 0.0 | 0.0 | 2.63 | 4.40 |
...
Average work units: 3.64

| Evidence path | count | % |
|---|---:|---:|
| `Desk+LooseRock` | 61 | 16.9 |
| `Desk+Refiner+LooseRock` | 70 | 19.4 |
| `Desk+LooseRock+CrossCheck` | 11 | 3.1 |
| `Desk+LooseRock+Refiner` | 2 | 0.6 |
| `Desk+Refiner+LooseRock+CrossCheck+Field` | 9 | 2.5 |
| `Desk+LooseRock+Refiner+CrossCheck+Field` | 3 | 0.8 |
| `Desk+Field+LooseRock` | 27 | 7.5 |
| `Desk+Refiner+LooseRock+CrossCheck` | 17 | 4.7 |
| `Desk+Refiner+Field+LooseRock` | 40 | 11.1 |
| `Desk+Field+LooseRock+CrossCheck` | 22 | 6.1 |
| `Desk+Field+LooseRock+CrossCheck+Refiner` | 36 | 10.0 |
| `Desk+LooseRock+CrossCheck+Field` | 2 | 0.6 |
| `Desk+Refiner+Field+LooseRock+CrossCheck` | 48 | 13.3 |
| `Desk+Field+Refiner+LooseRock+CrossCheck` | 2 | 0.6 |
| `Desk+LooseRock+CrossCheck+Field+Refiner` | 6 | 1.7 |
| `Desk+Field+Refiner+LooseRock` | 3 | 0.8 |
| `Desk+Field+LooseRock+Refiner` | 1 | 0.3 |
...
| Truth case | n | Hard% | Mineral% | Promising% | Hazard% | Mixed% | Unclear% | Rev% | Other% | AvgConf | AvgWork |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| Bedrock/Nominal | 40 | 95.0 | 0.0 | 0.0 | 0.0 | 5.0 | 0.0 | 0.0 | 0.0 | 3.95 | 2.38 |
| Bedrock/Fractured | 40 | 27.5 | 17.5 | 0.0 | 2.5 | 35.0 | 17.5 | 0.0 | 0.0 | 3.65 | 3.53 |
| Mineral/Nominal | 40 | 35.0 | 22.5 | 12.5 | 2.5 | 22.5 | 5.0 | 0.0 | 0.0 | 3.78 | 3.40 |
| Mineral/Dense | 40 | 45.0 | 2.5 | 7.5 | 2.5 | 42.5 | 0.0 | 0.0 | 0.0 | 3.58 | 3.48 |
| Mineral/Vein | 40 | 12.5 | 10.0 | 42.5 | 0.0 | 35.0 | 0.0 | 0.0 | 0.0 | 3.65 | 3.65 |
| Gas/Nominal | 40 | 0.0 | 0.0 | 0.0 | 35.0 | 60.0 | 5.0 | 0.0 | 0.0 | 3.40 | 4.05 |
| Gas/TrappedPocket | 40 | 0.0 | 0.0 | 0.0 | 10.0 | 85.0 | 5.0 | 0.0 | 0.0 | 3.15 | 4.73 |
| Mixed/Bedrock+Gas | 40 | 0.0 | 2.5 | 0.0 | 22.5 | 72.5 | 2.5 | 0.0 | 0.0 | 3.28 | 4.65 |
| Mixed/Bedrock+Mineral | 40 | 10.0 | 17.5 | 55.0 | 0.0 | 17.5 | 0.0 | 0.0 | 0.0 | 3.83 | 3.30 |
...
| Gold | 120 | 30.8 | 11.7 | 20.8 | 1.7 | 33.3 | 1.7 | 3.67 |
| Gas | 80 | 0.0 | 0.0 | 0.0 | 22.5 | 72.5 | 5.0 | 3.28 |
...
| `Desk+Refiner+LooseRock+CrossCheck` | 21 | 5.8 |
| `Desk+Refiner+LooseRock+CrossCheck+Field` | 87 | 24.2 |
| `Desk+LooseRock+CrossCheck+Field+Refiner` | 59 | 16.4 |
| `Desk+LooseRock+Refiner+CrossCheck+Field` | 4 | 1.1 |
| `Desk+LooseRock+CrossCheck` | 11 | 3.1 |
